...
found out that about $4\%$ of them are easy to break. The main issue were devices such as routers, internet-connected printers and such. These devices sometimes run variants of Linux--  a desktop operating system-- but without
